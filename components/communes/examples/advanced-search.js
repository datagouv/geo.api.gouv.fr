...
const AdvancedSearch = () => (
  <Section background='white'>
    <Tuto
      ...
      icon={<FaSliders />}
      exemple='https://geo.api.gouv.fr/communes?fields=code,nom,codesPostaux,surface,population,centre,contour&nom=versailles'
      code={json}
    ...
    >
      ...
      <div>
        ...
        <ul>
          <li>code</li>
          <li>codeDepartement</li>
          <li>codeRegion</li>
          <li>nom</li>
          <li>codesPostaux</li>
          <li>surface</li>
          <li>population</li>
          <li>centre (géométrie)</li>
          <li>contour (géométrie)</li>
          <li>departement</li>
          <li>region</li>
        </ul>
      </div>
